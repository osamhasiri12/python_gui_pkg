...
class GoalPublisherGUI(tk.Tk):
    ...
    def __init__(self, goal_publisher):
        ...
        text_label = tk.Label(self, text="Robotic Assistant for Medicine and Delivery in healthcare",bg='white',font=('Arial', 16))
        text_label.pack(pady=10)
        text_label.place(x=50, y=10)
        
        text_label = tk.Label(self, text="Select a room ", bg='white', font=('Arial', 16))
        text_label.pack(pady=10)
        text_label.place(x=250, y=60)
        
        

        room1_button = tk.Button(self, text='Room 1', command=self.publish_room1, bg='aquamarine3', fg='black', font=('Arial', 20), height=5, width=10, relief='ridge')
        room1_button.pack(pady=10)
        room1_button.place(x=50,y=100)

        room2_button = tk.Button(self, text='Room 2', command=self.publish_room2, bg='aquamarine3', fg='black', font=('Arial', 20), height=5, width=10, relief='ridge')
        room2_button.pack(pady=10)
        room2_button.place(x=250,y=100)

        room3_button = tk.Button(self, text='Room 3', command=self.publish_room3, bg='aquamarine3', fg='black', font=('Arial', 20), height=5, width=10, relief='ridge')
        room3_button.pack(pady=10)
        room3_button.place(x=450,y=100)
        
        exit_button = tk.Button(self, text="Exit", command=exit,bg='red', fg='white', font=('Arial', 20), height=2, width=37, relief='ridge')
